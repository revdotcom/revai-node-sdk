...
describe('get account', () => {
    ...
    test('handles when api returns unauthorized', async () => {
...
describe('get job details', () => {
    ...
    test('handles when api returns jobnotfound', async () => {
...
describe('submit job with media url', () => {
    ...
    test('handles when api returns insufficient credits', async () => {
    ...
    test('handles when api returns invalid parameters', async () => {
...
describe('get transcript object', () => {
    ...
    test('handles when api returns invalid state', async () => {
